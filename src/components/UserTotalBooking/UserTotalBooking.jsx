...
import "./UserTotalBooking.css"

import download from "../Icons/download.svg"

function UserTotalBooking() {
    return (
        <div>
                ...
                <div className="container">
                    <div className="row mb-4">
                        <div className="col col-all-title-10">
                            <h3 className="h2-title">Total Booking</h3>
                        </div>
                    </div>

                    <div className="col-sm-12 ">
                        <div className="table responsive table-mgeBooking-10">
                            <table id="myTable-mgeBooking-10" role="grid" className="table table-striped table-sm table-css table-responnsive " cellspacing="0" width="100%">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th className="th-sm cell-all-10" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style={{ width: "58px" }} >Vehicle Type

                                        </th>
                                        <th className="th-sm cell-all-10" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" style={{ width: "58px" }} >Vehicle Number
